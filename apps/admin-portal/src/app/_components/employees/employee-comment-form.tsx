...
import EmployeeMentionDropdown from "./employee-mention-dropdown";

interface EmployeeCommentFormProps {
  employeeId: string;
  mentionableEmployees: RouterOutputs["employees"]["getEmployeeLocationEmployees"];
}
...
export default function EmployeeCommentForm({
  employeeId,
  mentionableEmployees,
}: EmployeeCommentFormProps) {
  ...
  const { mutate: createEmployeeComment } =
    api.employeeComments.create.useMutation({
      onSuccess: () => {
        router.refresh();
        toast({
                ...
                <FormControl>
                  <div className="flex flex-col gap-y-2">
                    ...
                    <Textarea
                      ...
                      onKeyDown={(e) =>
                        handleKeyDown(e, mentionableEmployees ?? [])
                      }
                      onChange={(e) => {
                        field.onChange(e);
                        handleInputChange(
