      ...
      <div className="mx-auto max-w-3xl py-16">
        <div className="prose prose-gray max-w-none">
          <section className="mb-12">
            ...
            <p>
              At EboxSecure, we are committed to protecting your privacy and
              ensuring the security of your personal information. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your
              information when you use our secure package delivery service,
          ...
          <section className="mb-12">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              ...
              <li>
                Delivery information (package details, delivery preferences)
              </li>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              ...
              <li>Location data (when you access location-based features)</li>
          ...
          <section className="mb-12">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              ...
              <li>
                Sending notifications about package deliveries and pickups
              </li>
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              under 18, we will take steps to delete that information as quickly
              as possible.
            </p>
          </section>
