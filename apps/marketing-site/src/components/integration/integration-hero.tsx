        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Technical overview of EboxSecure's integration options, including
              our Shopify app, API documentation, and implementation details for
              retailers and businesses.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button asChild size="lg">
                <Link href="#shopify-integration">Shopify Integration</Link>
              </Button>
              <Button variant="outline" asChild size="lg">
                <Link href="#TODO:">Get Integrated</Link>
              </Button>
            </div>
          </div>
        </div>
