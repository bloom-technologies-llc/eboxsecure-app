        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Join our growing network of retail partners and offer your
              customers a secure, convenient delivery option that increases
              satisfaction and reduces delivery failures.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Button variant="outline" asChild size="lg">
                <Link href="#benefits">Partnership Benefits</Link>
              </Button>
            </div>
          </div>
        </div>
